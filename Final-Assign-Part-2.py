...
color_map = {
    'Supperminicar': '#1F77B4',
    'Mediumfamilycar': '#FF7F0E',
    'Smallfamiliycar': '#2CA02C',
    'Sports': '#D62728',
    'Executivecar': '#9467BD'
}
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            value = 'Select Statistics',
                style={'textAlign': 'center', 'font-size': '20px','width': '80%'}
        )                                ]),
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        xaxis=dict(
            tickmode='linear',  # Ensures all unemployment rates are shown as ticks
            tick0=0,  # Starting tick
            dtick=0.5  # Interval between ticks
        ),
        yaxis=dict(
            title='Average Automobile Sales',
            rangemode='tozero'  # Ensures the y-axis starts at zero
        ),
        legend_title='Vehicle Type',  # Sets the title for the legend
        legend_title_font_size=16  # Optional: sets the font size for the legend title
    ))


        return [
    # Primera fila con las gráficas 1 y 2
